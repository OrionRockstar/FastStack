...
AHD::AutoHistogramDialog(QWidget* parent) : ProcessDialog("AutoHistogram", QSize(710, 455), FastStack::recast(parent)->workspace()) {

    setTimer(250, this, &AHD::applytoPreview);

    connectToolbar(this, &AHD::apply, &AHD::showPreview, &AHD::resetDialog);
    connectZoomWindow(this, &AHD::applytoPreview);
